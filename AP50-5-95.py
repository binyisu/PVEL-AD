...
MINOVERLAP = 0.50
# for i in range(10):
# MINOVERLAP=MINOVERLAP+0.05
parser = argparse.ArgumentParser()
parser.add_argument('-a', '--no-animation', help="no animation is shown.", action="store_true")
parser.add_argument('-p', '--no-plot', help="no plot is shown.", action="store_true")
...
for i in range(10):
    ...
    with open(results_files_path + "/results.txt", 'w') as results_file:
        ...
        # subinyi
        sum_mAP = sum_mAP + mAP
        text1 = "sum_mAP = {0:.2f}%".format(sum_mAP * 100)
        print(text1)
...
AP50_5_95 = sum_mAP/10
text2 = "AP50_5_95 = {0:.2f}%".format(AP50_5_95*100)
print(text2)

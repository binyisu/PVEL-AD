...
# News
[2021-12-14]: Data augmentation via horizontal_flipping.py. First, converting test xml to txt by get_gt_txt.py. Second, appling AP50-5-95.py to evaluate the detection results.
